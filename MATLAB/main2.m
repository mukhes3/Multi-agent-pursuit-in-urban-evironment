...
filename_prefix = 'PRESENTATION_DSSN_project';
FrameRate = 6;
Quality = 30;
...
if SHOW_SIMULATION || RECORD_GLOBAL_VIDEO 
  ...
  axis([evader.pos(1)-2*blockLength,...
    evader.pos(1)+2*blockLength,...
    evader.pos(2)-2*blockLength,...
    evader.pos(2)+2*blockLength])
  %
